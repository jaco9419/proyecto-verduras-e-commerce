...
import PostQuoteResponse from '../Components/PostQuoteResponse';

function Pedidos() {
    const [
        { basket, qtyBasket, accountPath, isQuoteResponseOpen },
    ] = useStateValue();
    ...
    return (
        <div className="pedidos__container">
            ...
            {/* Revisa que el formulario se haya enviado correctamente para mostrar mensaje de éxito */}
            {isQuoteResponseOpen && <PostQuoteResponse />}
